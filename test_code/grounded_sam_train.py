...
def grounded_sam(qwen_processor, qwen_model, dino_processor, dino_model, sam_processor, sam_model, pil_image, object_description, rgb_base64):
    ...
    object_description = object_description # From dataset
    ...
    '''
    mllm_result = generate_object_description(rgb_base64)
    ...
    print("MLLM output:", output_text[0])
